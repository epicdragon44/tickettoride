...
public class GameEngine {
	...
	private boolean checkEligibility(Node nodeOne, Node nodeTwo, Color c) {
		int rand = players[currentPlayer].getTrainCards().get(new TrainCard(null, true)),
				col = players[currentPlayer].getTrainCards().get(new TrainCard(c, false)),
				cost = gBoard.connectionCost(nodeOne.toString(), nodeTwo.toString());
